...
!(function(e, t) {
    ...
    function f(...e) {
        ...
        for (let i = 1; i < e.length; i += 1) {
            ...
            if (
                null != r &&
                ((a = r), !("undefined" != typeof window && void 0 !== window.HTMLElement ?
    ...
    function S(e) {
        ...
        if ("wrapper" === l.touchEventsTarget && !h.closest(t.wrapperEl).length)
            return;
        if (
            ((n.isTouchEvent = "touchstart" === c.type), !n.isTouchEvent && "which" in c && 3 === c.which)
        )
            return;
    ...
    function M(e) {
        ...
        if (
            (r.touchReleaseOnEdges && (b = 0),
                ...
                w && (p.preventedByNestedSwiper = !0), !s.allowSlideNext &&
    ...
    function O() {
        ...
        e.isHorizontal() ?
            ...
            (e.translate = -t.scrollTop), -0 === e.translate && (e.translate = 0),
            e.updateActiveIndex(),
            e.updateSlidesClasses();
            ...
            function g(t) {
                ...
                if (
                    ("container" !== e.params.mousewheel.eventsTarget &&
                        (o = d(e.params.mousewheel.eventsTarget)), !e.mouseEntered && !o[0].contains(s.target) && !r.releaseOnEdges)
                )
                    return !0;
                    ...
                    (u.$slideEl ||
                        (t &&
                            ...
                            (u.$imageEl = u.$slideEl
                                ...
                                .find("picture, img, svg, canvas, .swiper-zoom-target")
                                .eq(0)),
                            (u.$imageWrapEl = u.$imageEl.parent(`.${a.containerClass}`))), !u.$imageEl ||
                        0 === u.$imageEl.length ||
                        !u.$imageWrapEl ||
                        0 === u.$imageWrapEl.length)
                )
